...
from quantize import TurboQuantMSE, TurboQuantProd, BinaryHash, ProductQuantization, FP32Exact
...
def run_single_config(model_name: str, dataset_name: str, method: str,
    ...
    elif method in ("turboquant_mse", "turboquant_prod"):
        cls = TurboQuantMSE if method == "turboquant_mse" else TurboQuantProd
        tq = cls(d, bits, seed, rotation_type="srht")
        ...
        for dataset_name in datasets:
            ...
            for method in methods:
                for bits in args.bits:
                    ...
                    if method in ("fp32_exact", "binary_hash") and bits != args.bits[0]:
                        continue
